...
import 'package:baybn/pages/services/status_post_management.dart';
...
class CreateStatusTextState extends State<CreateStatusText> {
  ...
  final StatusPostManagement statusPostManagement = StatusPostManagement();
  String _statusText = '';
  List themeColors = [
  ...
  sendStatus(_statusValues) {
    ...
    // sending new status post to status management before database upload
    statusPostManagement.addStatusPost(_statusValues);
