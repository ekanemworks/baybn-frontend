...
import 'package:baybn/pages/private/moments_pages/filterDiscoverMember.dart';
...
class MakeFriendsState extends State<MakeFriends> {
  ...
  void _useFilter(filterCondition) {
    httpService.fetchMembersFiltered(filterCondition).then(
          (value) => {
            setState(() {
              _baybn_members_general = value['body'];
              // print(interestAvailable);
                    ...
                    child: Container(
                      child: Row(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                            onPressed: () async {
                              _matayasMAP = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          FilterDiscoverMember(),
                                    ),
                                  ) ??
                                  {};

                              if (_matayasMAP['gender'] != null) {
                                // print(_matayasMAP);
                                _useFilter(_matayasMAP);
                              }
                            },
                            child: Row(
                              children: [
